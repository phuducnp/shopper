...
ActiveRecord::Schema.define(version: 20191009154114) do
  ...
  create_table "spree_page_third_party_services", force: :cascade do |t|
    ...
    t.index ["page_id", "third_party_service_id"], name: "spree_page_third_party_services_page_id_third_party_service_id", using: :btree
    t.index ["page_id"], name: "index_spree_page_third_party_services_on_page_id", using: :btree
    t.index ["third_party_service_id"], name: "indx_spree_page_third_party_services_on_third_party_service_id", using: :btree
  end
